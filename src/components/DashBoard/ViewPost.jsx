          ...
          >
            ...
            {hoveredPostId === post.id && (
              <div className="absolute top-0 right-0 mt-2 mr-2 ">
                <IconButton onEdit={() => onEdit(post)} onDelete={onDelete} post={post} />
              </div>
            )}
    ...
    <div className="flex flex-col">
      ...
      {showDropdown && (
        <div className="flex flex-col justify-left pl-2 pr-2 text-lg leading-9 whitespace-nowrap bg-white rounded-2xl border border-solid border-stone-300 absolute mt-12 -ml-12">
          ...
          <div onClick={handleDeleteClick} className="group flex gap-2 justify-between rounded-xl items-center cursor-pointer hover:bg-[#009dfd] hover:text-white  hover:pl-1 hover:pr-1">
            <div>Delete</div>
