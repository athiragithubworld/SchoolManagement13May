...
const EmployeeAttendanceButtons = ({handleSelectionCategory , filteredEmployeeData}) => {
  ...
  return (
    <div className="flex gap-5 justify-between max-md:flex-wrap">
      ...
      <span className={`${styles.feelistRight} flex gap-2`}>
        {/* <button className="bg-[#009dfd] flex items-center rounded-[14px] p-2 gap-1 text-white ">
          Add New
          <IoMdAdd />
        </button> */}
        <IconButton />
