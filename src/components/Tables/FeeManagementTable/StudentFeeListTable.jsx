...
const StudentListTable = ({ tableData, filterOption,handleUpdateEachRowDetails,handleRefetch }) => {
  ...
  const handleRowData=(student)=>{   //function for sending data to popup
    const pendingFee= student.pendingFee ===0? student.pendingFee : parseFloat(student.totalFees) - parseFloat(student.totalPaid);
  ...
  return (
    <>
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="w-32 h-fit text-custom lg:text-custom text-center font-normal text-red-800">
                            &#8377; {student.pendingFee===0 ? student.pendingFee : student.totalFees - student.totalPaid}
                          </td>
                          <td className="w-32 h-fit text-custom lg:text-custom text-center font-normal">
                            &#8377; {student.totalFees}
                          </td>
      ...
      <Modal handleClose={closeModal} isOpen={showRequestFeePopup}>
        <RequestFeePopup requestId={requestId} handleClose={closeModal} />
      </Modal>
      <Modal handleClose={closeModal} isOpen={showFeeCollectionPopup}>
        <FeeCollectionPopup handleDataRefetch={handleDataRefetch} feeRowData={tableRowData} updateEachFeeDetails={updateEachFeeDetails} handleClose={closeModal}/>
      </Modal>
