...
export default function StudentListSteps({ handleClose , handleAddStudentDetails}) {
  ...
  const studentAllDetails = {...studentDetails,...parentDetails,StudentId : Math.random()}
    ...
    <Modal handleClose={closeModal} isOpen={showModal}>
      <div className={classes.container}>
        ...
        {step === 3 && (
          ...
          //       />
          //     </div>
          //     <div className="flex justify-center items-center px-3 py-2 w-10 h-10 bg-white rounded-2xl border border-solid border-stone-300">
          //       <img
          //         loading="lazy"
        ...
        {step === 1 && <StudentDetails studentDetails={studentDetails} setStudentDetails={setStudentDetails}/>}
        {step === 2 && <ParentDetailsPopup parentDetails={parentDetails} setParentDetails={setParentDetails}/>}
        {step === 3 && (<StudentListDocuments step={2} currentStep={step}
        ...
        <span className={classes.parentbutton}>
          ...
          {step === 3 && (
            <button className={classes.submitbutton} onClick={()=>submitHandler(studentAllDetails)}>
              <span> Save</span>
            </button>
          )}
        </span>
