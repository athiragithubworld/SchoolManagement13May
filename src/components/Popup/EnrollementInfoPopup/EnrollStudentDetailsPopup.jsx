...
function InputField({
  ...
  return (
    <div className="flex gap-1">
      ...
      {label !== "Status" && (
        <input
          className={`shrink-0 bg-white rounded-2xl shadow-primary h-[53px] w-[190px] md:w-[190px] outline-none ${className} text-center`}
...
export default function EnrollStudentDetailsPopup({
  ...
  // console.log("tttt", enrollstudentDetails);

  return (
    <section className="flex flex-col bg-white rounded-3xl max-w-[full] max-md:px-5 h-[324px] overflow-y-scroll">
        ...
        {inputFields.slice(0, 3).map((field, index) => (
          <InputField
            ...
            value={
              ...
              //     ]
              // : ""
            } // Access the value based on the label
          />
        ))}
      </div>
      <div className="flex gap-3 justify-between px-px mt-3 text-base leading-5 text-black md:flex-wrap flex-wrap">
