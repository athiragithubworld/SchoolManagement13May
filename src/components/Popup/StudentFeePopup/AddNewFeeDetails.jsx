...
export default function AddNewFeeDetails({  closeModal,rowDetails,handleAddNew,updateEachFeeDetails,handleDeleteEachFeeDetails }) {
   ...
   const postFormData = (formData,id) => {
    if(id!==null){                           
      fetch(`http://localhost:4000/StudentFeeDetails/${id}`, {    //for updating data in the table
        ...
        {               //for posting new data in the table
