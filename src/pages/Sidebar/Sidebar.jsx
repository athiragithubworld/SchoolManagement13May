...
const Sidebar = () => {
  ...
  return (
    <div className={custom.sidebar}>   
      <div id="accordion-color" data-accordion="collapse" data-active-classes="bg-customblue text-white dark:text-white">
        {/* Mapping through accordion items to render each accordion */}
        {accordionItems.map((item, index) => (
          <div key={index} className={`${custom.features} shadow-primary rounded-xl mb-2`}>
            ...
            <div id={`accordion-color-body-${index + 1}`} className="hidden" aria-labelledby={`accordion-color-heading-${index + 1}`}>
              <div className="border-t border-gray-300 mt-2"></div>
              <div className="p-2">
                <div className={custom.dropdowncontent}>
                  {/* Mapping through options of the accordion item */}
